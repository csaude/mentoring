...
public class MentorshipQueryServiceImpl implements MentorshipQueryService {
	...
	@Override
	public List<Mentorship> findBySelectedFilter(final UserContext userContext, String code, String tutor,
			String tutored) {
	...
	public List<Mentorship> countMentorshipByHealthFacility(HealthFacility healthFacility) {
		return mentorshipDAO.countMentorshipByHealthFacility(healthFacility, LifeCycleStatus.ACTIVE);
	}
